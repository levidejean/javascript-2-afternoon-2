...
/*
  ...
  //argument. Loop through the given array and alert every item in 
  //the array.
*/
...
/*
  ...
  //only argument. Loop through the given array backwards alerting 
...
/*
  ...
  //argument. Return an array that contains the even numbers from the 
  //nums array.
*/
...
/*
  Write a function called divider that is given one argument, 
  //numbersArray. Have divider return an Array with the first item in 
  //the array being the evens array (all the even values from 
  //numbersArray) and the second item in the Array being the odds array
...
function divider(numbersArray){
  ...
  for(var i = 0; i< numbersArray.length; i++){
    var currentItem = numbersArray[i];
  ...
  arrContainer.push(evensArr);
  arrContainer.push(oddsArr);
...
/*
  ...
  //and the second is an item to remove from myGroceryList. If the second argument 
  //(or the item to add or remove) matches an item in myGroceryList, remove that item from the 
  ...
  //is myGroceryList and the second is an item to add to your grocery list. 
  In addItem add the item you passed in to myGroceryList then return the new, updated grocery 
  //list.

  In both removeItem and addItem check to see if the 'myGroceryList' and 'item' arguments are 
  //truthy. If they are not, return an empty array.
  ...
  if(myGroceryList && item){
    for(var i = 0; i<myGroceryList.length; i++){
      if(myGroceryList[i]===item){
        var firstPart = myGroceryList.splice(0, i-1);
        var secondPart = myGroceryList.splice(i+1, myGroceryList.length - i+1);
...
const index = devMountainEmployees.indexOf(cahlan);
if (index !== -1) {
...
users = [];
users.push( {name: "Levi", email: "@.com", password: "nope", username: "me"} );
users.push( {name: "Levi", email: "@.com", password: "nope", username: "me"} );
users.push( {name: "Levi", email: "@.com", password: "nope", username: "me"} );
users.push( user1 );
...
/*
  ...
  Loop through your array of objects until you find Tyler's account (use tylermcginnis33@gmail.com 
  to find him).
